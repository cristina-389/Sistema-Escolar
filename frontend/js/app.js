...
const dadosTurmas = {
    ...
    "3º Ano A":[
      {nome:"Ana Clara Vaconcelo",nota:8.5},
      {nome:"Arthur Costa",nota:6.7},
      {nome:"Alice Moura",nota:9.2},
      {nome:"Aurora Albuquerque",nota:7},
      {nome:"Bento Castilho",nota:7},
      {nome:"Bernardo Pereira",nota:9},
      {nome:"Batriz Miranda",nota:5},
      {nome:"Bel Rocha",nota:8},
      {nome:"Carlos Vieira",nota:10},
      {nome:"Carol Martins",nota:9.8},
      {nome:"Carla Machado",nota:7},
      {nome:"Caila Vasco",nota:10},
      {nome:"Davi Rocha",nota:3},
      {nome:"Gael Oliveira",nota:6.7},
      {nome:"Gabriel Carvalho",nota:10},
      {nome:"Heitor Mendes",nota:5},
      {nome:"Lucas Fernandes",nota:7},
      {nome:"Luana Marcela",nota:10},
      {nome:"LUiz Davi",nota:4},
      {nome:"Luna Nogueira",nota:8},
      {nome:"Noah Martins",nota:10},
      {nome:"Miguel Silva",nota:9.8},
      {nome:"Mariana Dantas",nota:10},
      {nome:"Maria Clara Azevedo",nota:10},
      {nome:"Maria Alice Vieira",nota:7},
      {nome:"Otavio da Silva",nota:10},
      {nome:"Pedro Henrique",nota:4},
      {nome:"Samuel Augusto",nota:8},
      {nome:"Sophia Toledo",nota:10},
      {nome:"Théo Almeida",nota:9.8},
      {nome:"Tiago Marcelo",nota:10},
      {nome:"Thaís Mariana",nota:10}
    ],
  
    "2º Ano B":[
      {nome:"Alice Rocha",nota:8.8},
      {nome:"Arthur Silva",nota:6.0},
      {nome:"Beatriz Oliveira",nota:7.2},
      {nome:"Bernardo Pereira",nota:8.8},
      {nome:"Camila Souza",nota:6.0},
      {nome:"Davi Santos",nota:7.2},
      {nome:"Eloá Costa",nota:8.8},
      {nome:"Enzo Ferreira",nota:6.0},
      {nome:"Fernanda Rodrigues",nota:7.2},
      {nome:"Gabriel Alves",nota:8.8},
      {nome:"Helena Lima",nota:6.0},
      {nome:"Heitor Gomes",nota:7.2},
      {nome:"Isabela Martins",nota:8.8},
      {nome:"João Costa",nota:6.0},
      {nome:"Julia Almeida",nota:7.2},
      {nome:"Lucas Rocha",nota:5},
      {nome:"Manuela Carvalho",nota:6}
    ],
    ...
    "9º Ano D":[
      ...
      {nome:"Lucas Rocha",nota:5},
      {nome:"Manuela Carvalho",nota:6},
      {nome:"Matheus Barbosa",nota:4},
      {nome:"Melissa Castro",nota:8.8},
      {nome:"Miguel Fernandes",nota:6.0},
      {nome:"Nicolas Cardoso",nota:3},
      {nome:"Nicole Azevedo",nota:4},
      {nome:"Olivia Gonçalves",nota:6.0},
      {nome:"Pedro Ribeiro",nota:7.2},
      {nome:"Pedro Mathias",nota:7.2}
    ]
